...
define(['dojo', 'dojo/_base/declare', 'ebg/core/gamegui', 'ebg/counter'], function (dojo, declare, gamegui, counter) {
	return declare('bgagame.theisleofcatsduel', ebg.core.gamegui, {
		constructor: function () {
			console.log('theisleofcatsduel constructor')
				...
				switch (stateName) {
					case 'BoatChoice':
						this.statusBar.addActionButton(
							...
							() => this.bgaPerformAction('actChooseBoat', { boat: 'OBoat' }),
							{}
						)
						this.statusBar.addActionButton(
							_('Choose the second boat'),
							() => this.bgaPerformAction('actChooseBoat', { boat: 'IBoat' }),
							{}
						)
						break
					case 'PlayerTurn':
