...
use Bga\Games\TheIsleOfCatsDuel\TiocShape;
...
class GameTest extends GameTestBase { // this is your game class defined in ggg.game.php
    ...
    function testOBoatGetPlayerUnfilledRoomIdsWithCentralZone() {
        ...
        $shapeMgr = new TiocShapeMgr($this, $shapes);
        $result = $shapeMgr->getPlayerUnfilledRoomIds(2333092, "OBoat");
        $equal = $result == $this->getAllRoomsExcept(BOAT_ROOMS_ID_PARROT_FRONT + 1);
        $this->displayResult(__FUNCTION__, $equal, $result);
    }

    function getAllRoomsExcept($exceptedRoom) {
        $rooms = [
            BOAT_ROOMS_ID_PARROT_BACK,
            BOAT_ROOMS_ID_MOON_TOP,
            BOAT_ROOMS_ID_MOON_BOTTOM,
    ...
    function testAll() {
        ...
        $this->testOBoatGetPlayerUnfilledRoomIdsWithMoonTop();
        $this->testOBoatGetPlayerUnfilledRoomIdsWithMoonBottom();
        $this->testOBoatGetPlayerUnfilledRoomIdsWithParrotBack();
        $this->testOBoatGetPlayerUnfilledRoomIdsWithAppleMiddle();
        $this->testOBoatGetPlayerUnfilledRoomIdsWithCornFront();
        $this->testOBoatGetPlayerUnfilledRoomIdsWithParrotFront();
        $this->testOBoatGetPlayerUnfilledRoomIdsWithCentralZone();
    }
}
